			...
			<section className="profile">
				<div className="profile__pos-left">
					<img className="profile__avatar"
						alt="Цветная фотография крупным планом человека в красной шапке на улице, лицо в фокусе, фон размыт" src={props.userAvatar} />
					<button className="profile__avatar-button" onClick={props.onEditAvatar}></button>
					<div className="profile-info">
						<div className="profile-info__line">
							<h1 className="profile-info__title">{props.userName}</h1>
						...
						<p className="profile-info__subtitle">{props.userDescription}</p>
					</div>
				</div>
